...
describe('FocusWithinDirective', () => {
  ...
  it('should call focusin on click inside', async(() => {
    const a = compiled.querySelector('a');
    a.click();
    expect(focusinSpy).toHaveBeenCalledTimes(1);
  }));

  it('should not call focusin on click outside', async(() => {
    const h1 = compiled.querySelector('h1');
    h1.click();
    expect(focusinSpy).toHaveBeenCalledTimes(0);
  }));

  it('should call focusout on click outside', async(() => {
    const a = compiled.querySelector('a');
    const h1 = compiled.querySelector('h1');
    a.click();
    h1.click();
  ...
  it('should not call focusin or focusout on click inside focuswithin element', async(() => {
    const a = compiled.querySelector('a');
  ...
  it('should add css class on click inside', async(() => {
    const a = compiled.querySelector('a');
    a.click();
    fixture.detectChanges();
  ...
  it('should not add css class on click outside', async(() => {
    const h1 = compiled.querySelector('h1');
    h1.click();
    fixture.detectChanges();
  ...
  it('should remove css class on click outside', async(() => {
    const a = compiled.querySelector('a');
    const h1 = compiled.querySelector('h1');
    a.click();
    fixture.detectChanges();
  ...
  it('should keep css class on click inside', async(() => {
    const a = compiled.querySelector('a');
    const span = compiled.querySelector('span');
    a.click();
    fixture.detectChanges();
  ...
  it('should call focusin on autofocus', async(() => {
